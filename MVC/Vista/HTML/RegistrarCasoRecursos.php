...
<body>
    <div class="container">
        <h2>Registrar Caso de Donación de Recursos</h2>
        ...
        <form action="../../Controlador/Controlador.php" method="POST" enctype="multipart/form-data">
            ...
            <label>Puntos de Recoleccion:</label>
            <input type="text" name="casoPuntoRec" required></input><br>
            ...
            <button type="submit" name="registrarCasoRec">Crear Caso Recursos</button>
        </form>
    </div>
</body>
</html>