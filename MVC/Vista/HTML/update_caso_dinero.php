...
try {
  ...
  ");
  $stmt->execute([
    $d['Caso_Nombre'],$d['Caso_Descripcion'],$d['Caso_Monto_Meta'],
    $d['Caso_Monto_Recaudado'],$d['Caso_Fecha_Inicio'],$d['Caso_Fecha_Fin'],
    $d['Caso_Estado'],$d['Caso_Imagen'] ?? '',$d['Caso_Voluntariado'] ?? 0,
    $d['Caso_Cat_Nombre'],$d['Caso_Id'],$_SESSION['id_fundacion']
  ]);
  echo json_encode(['success'=>true,'message'=>'Caso de dinero actualizado']);
