...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2025 a las 05:50:35
...
CREATE TABLE `tbl_fundaciones` (
  ...
  `Fund_NIT` varchar(50) DEFAULT NULL,
  ...
  `Fund_Ruta_Documento` varchar(255) DEFAULT NULL,
  `Fund_Estado_Verificacion` enum('pendiente','verificado','rechazado') NOT NULL DEFAULT 'pendiente'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_fundaciones` (`Fund_Id`, `Fund_Correo`, `Fund_Username`, `Fund_NIT`, `Fund_Direccion`, `Fund_Casos_Activos`, `Fund_Telefono`, `Fund_Usu_Id`, `Fund_Imagen`, `Fund_Ruta_Documento`, `Fund_Estado_Verificacion`) VALUES
(13, 'fund13@correo.com', 'Fundacion 13', NULL, 'cr. 8 cll. 222', 2, 31384567, 2, 'img_684b104ee5c177.95954465_tipos-de-donaciones.jpg', NULL, 'pendiente'),
(14, 'tapitasxpatitas@outlook.com', 'Tapitas por Patitas', NULL, 'Cra 12 #34‑56', 1, 314555667, 9, '', NULL, 'pendiente'),
(15, 'Borreguito@gmail.com', 'Boreguito', NULL, 'CRA 90-10 bmw', 3, 10231232, 11, 'img_684b0e0301d169.45187413_tipos-de-donaciones.jpg', NULL, 'pendiente'),
(16, 'Totolindo@gmail.com', 'Totoooo1', NULL, 'calle 90', 2, 123456789, 22, 'img_684b102b9890d8.70525362_WhatsApp Image 2025-02-04 at 12.12.19 PM.jpeg', NULL, 'pendiente'),
(17, 'Federaciondebellacosinternacionales@gmail.com', 'FBI', NULL, 'Titan plaza', 1, 2147483647, 23, 'default.png', NULL, 'pendiente'),
(18, 'fundacion66@gmail.com', 'fundacion66', '4566', '', 0, 0, 30, '', 'cert_6858b68daf25e__Diagrama de colaboración - Donante.pdf', 'pendiente'),
(19, 'HMMI8899@gmail.com', 'HMMI', '788001', '', 0, 0, 31, '', 'cert_685987a48280e_Manual de usuario - Pantry Amigo.docx.pdf', 'verificado'),
(23, 'jequinsil1200@gmail.com', 'Healthy', '788999', '', 0, 0, 35, '', 'cert_685b699f109b2_Pruebas de software, Unitaria - Integral.pdf', 'verificado');
...
(5, '2025-07-07 14:00:00', 'Titan plaza', 1011320651);
...
(23, 'alec_freal.12', '1244', 'Usuario', 'laspipsas@example.com'),
(24, 'Daniflow', '$2y$10$ppRmBaxjQErnl', 'Usuario', 'jeqyuinsil1200@gmail.com'),
(25, 'Moneda12', '$2y$10$FTyl5V5J0ZANK', 'Usuario', 'elquesabasabe@gmail.com'),
(26, 'Puli', '$2y$10$oJ0ZPYSDCrXFH', 'Administrador', 'example250@gmail.com'),
(27, 'Santiago', '$2y$10$MqZSA8FFPr.LYCisoB0.muiCbrBZ42qw8DJYXyAXKHtLsjG3ZmCyu', 'Administrador', 'example405@gmail.com'),
(28, 'fundacion123', '$2y$10$OwSBBtwsVOf3R4mQwm/SJ.3O76BE4B/.Eg.V4dlUfeF12REii8DtW', 'Usuario', 'example12@gmail.com'),
(29, 'fundacion12', '$2y$10$Mkd7.yqsVe54.hwORoEX7ucmPvYxQWjSoXEXfOhtWmzWYGaA8p/02', 'Usuario', 'fundacion12@gmail.com'),
(30, 'fundacion66', '$2y$10$VILR3ADrYs0fDXKSI2H7l.NIpxys2rpqDIrMjLQAb3Ob/WWb8vjA2', 'Usuario', 'fundacion66@gmail.com'),
(31, 'HMMI', '$2y$10$x7xXkZ50eP1Q/seQDtOBkugGIkKz9UvcK1XM8z5Eek0qSETNPMG6e', 'Usuario', 'HMMI8899@gmail.com'),
(35, 'Healthy', '$2y$10$pbq0wREElFTzi6qscBIEnugNVBOfMcyFbRGgP3z9wOvCLX/CkRnuO', 'Usuario', 'jequinsil1200@gmail.com');
...
--
ALTER TABLE `tbl_fundaciones`
  MODIFY `Fund_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `tbl_horarios_voluntarios`
--
ALTER TABLE `tbl_horarios_voluntarios`
  MODIFY `Hora_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `tbl_usuario`
--
ALTER TABLE `tbl_usuario`
  MODIFY `Usu_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
